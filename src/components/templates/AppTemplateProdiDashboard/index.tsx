...
import { IRouteItem, ROUTING_PRODI_DASHOBARD_PAGES } from '@/constant/route';
...
const AppTemplateProdiDashboard: React.FC<IProps> = (props) => {
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  return (
    ...
    >
      ...
      {ROUTING_PRODI_DASHOBARD_PAGES[userType].map(
        (route: IRouteItem, index: number) => (
          <Box my='3' key={index}>
            {index + 1 === ROUTING_PRODI_DASHOBARD_PAGES[userType].length ? (
...
export default AppTemplateProdiDashboard;
